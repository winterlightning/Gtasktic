            ...
            if cloud_unit['id'] == local_unit["id"]:
                ...
                if local_unit.has_key("time"):
                    ...
                    if cloud_unit.has_key('updated'):
                        ...
                        any_difference = compare (cloud_unit, entry)
                        
                        print "#IS THERE ANY DIFFERENCE: ", compare (cloud_unit, entry)
...
#compare the two
def compare (cloud_unit, local_translated):
